...
public final class QuaternionMath {
    ...
    private QuaternionMath() {
        throw new IllegalStateException("Tried to initialize: QuaternionMath but this is a Utility class.");
    }
     ...
     *
     * @param a The first quaternion to interpolate from.
     * @param b The second quaternion to interpolate to.
     * @param blend
